...
namespace EConnect.Psb.WebHook
{
    ...
    {
        private static string CreateSignatureText(this HMACSHA256 hmacSha256, byte[] messageHash)
        {
        ...
        public static string ComputeSignature(string message, string secret)
        {
            ...
            return hmacSha256.CreateSignatureText(messageHash);
        }
        ...
        public static async Task<string> ComputeSignature(Stream body, string secret)
        {
            ...
            try
            {
                ...
                return hmacSha256.CreateSignatureText(hmacSha256.Hash);
            }
            finally
            {
